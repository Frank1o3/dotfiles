...
return function(mainMod, terminal, fileManager, menu, ide, scripts_dir)
	...
	-- ✅ FIXED: Clean syntax, valid bash redirection, and no trailing spaces
	hl.bind(mainMod .. " + M", hl.dsp.window.close())

	hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(fileManager))
	hl.bind(mainMod .. " + F", hl.dsp.window.float({ action = "toggle" }))
	hl.bind(mainMod .. " + R", hl.dsp.exec_cmd(menu))
	hl.bind(mainMod .. " + V", hl.dsp.exec_cmd(ide))
